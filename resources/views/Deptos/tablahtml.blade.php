...
<h1 class="text-center mt-4" style="font-family: 'Times New Roman', Times, serif; color: #0a0a0a;">Departamentos</h1>
    ...
    <table class="table table-hover table-striped table-bordered" style="border-radius: 8px; overflow: hidden;">
        <thead class="table-dark">
            <tr>
                ...
                <th scope="col" style="font-family: 'Times New Roman', Times, serif; color: #ffffff;">Nombre Del Departamento</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('Deptos.edit', $depto->idDepto) }}" class="btn btn-sm btn-edit">
                        <i class="fas fa-edit"></i> Editar
                    </a>
                </td>
                <td>
                    <a href="{{ route('Deptos.show', $depto->idDepto) }}" class="btn btn-sm btn-delete">
                        <i class="fas fa-trash-alt"></i> Eliminar
                    </a>
                </td>
                <td>
                    <a href="{{ route('Deptos.show', $depto->idDepto) }}" class="btn btn-sm btn-view">
